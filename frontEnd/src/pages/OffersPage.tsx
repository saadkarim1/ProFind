...
const OffersPage = () => {
	...
	return (
		<section className='relative'>
			...
			{/* <div className='top-30 fixed bg-amber-200/20 h-screen w-[80%] flex justify-center'>
				<div className='border-2 border-[#e9e9e9] bg-white'>
					<button
						// onClick={handlePopUp}
						className='cursor-pointer sticky bottom-0 w-fit h-fit text-[14px] font-medium py-1.5 px-3 border-2 text-white border-[#0082FA]  rounded-xl bg-[#0082FA]'
					>
						Show Applicants
					</button>
				</div>
